...
public final class Easy4TardisButHard4EvoConfigurator implements OptionsConfigurator {
	@Override
	public void configure(Options o) {
		final String targetClass = "synergy/Easy4TardisButHard4Evo";
		...
		o.setUseIndexNovelty(true);
		o.setIndexNoveltyBranchPattern("sinergy/Easy4TardisButHard4Evo:.*:.*:.*:.*");
		o.setUseIndexImprovability(true);
		o.setIndexImprovabilityBranchPattern("sinergy/Easy4TardisButHard4Evo:.*:.*:.*:.*");
	}
}
